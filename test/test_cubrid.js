...
async function performAction(client, key, action) {
    ...
    if(!report["cubrid"]){
        report["cubrid"] = {"manual": {}}
    }else if(!report["cubrid"]["manual"]){
        report["cubrid"]["manual"] = {}
    }

    report["cubrid"]["manual"][key] = d

}

describe('CUBRID Performance Tests', function() {
    ...
    it('should perform a select operation quickly', async function() {
        ...
        report["cubrid"]["manual"]["select"] = duration
    });
